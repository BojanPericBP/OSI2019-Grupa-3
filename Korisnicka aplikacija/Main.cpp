...
//todo ako se program prekine u switchu (izborom opcije E u meniju) treba osloboditi niz dat_dogadjaji U SVAKOM SWITCH-U

int main()
{
	inicijalizuj_prozor();

	FILE* dat_dogadjaji = fopen("../config files/dogadjaji.txt","r");
	...
	odabir_opcije_korisnika(lista_dogadjaja);
